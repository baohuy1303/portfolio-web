...
import { faServer, faFire, faDatabase, faLeaf, faRobot, faCodeCompare, faCodeCommit, faHashtag, faPaintBrush, faGamepad, faCamera, faCrow, faBoltLightning, faScrewdriverWrench } from "@fortawesome/free-solid-svg-icons";
